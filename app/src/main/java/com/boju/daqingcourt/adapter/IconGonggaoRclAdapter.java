...
public class IconGonggaoRclAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    List<IconGonggaoInfo> dateAllList;

    public IconGonggaoRclAdapter(Context context, List<IconGonggaoInfo> dateAllList) {
        this.context = context;
        this.dateAllList = dateAllList;
    }
    public final void addItem(int position,IconGonggaoInfo dataInfo) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mFooterView != null && viewType == TYPE_FOOTER) {
            ...
            View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_icon_gonggao, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == TYPE_NORMAL) {
            if (holder instanceof ListHolder) {
                ...
                ((ListHolder) holder).tv_court.setText(dataInfo.getCourt());
                ((ListHolder) holder).tv_judge.setText(dataInfo.getJudge());
                ((ListHolder) holder).tv_start_time.setText(dataInfo.getStart_time());
                //设置单击事件
    ...
    class ListHolder extends RecyclerView.ViewHolder {
        TextView tv_number, tv_court, tv_judge, tv_start_time;
        public ListHolder(View itemView) {
            ...
            tv_court = itemView.findViewById(R.id.tv_court);
