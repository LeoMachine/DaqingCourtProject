...
public class DocumentsPublicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    List<DocumentInfo> dateAllList;

    public DocumentsPublicAdapter(Context context, List<DocumentInfo> dateAllList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mFooterView != null && viewType == TYPE_FOOTER) {
            ...
            View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_document_public, parent, false);
