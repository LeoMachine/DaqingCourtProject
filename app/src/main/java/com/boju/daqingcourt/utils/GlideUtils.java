...
public class GlideUtils {
    ...
    //设置加载中以及加载失败图片
    public static void loadImageViewUser(Context mContext, String path, ImageView mImageView) {
        Glide.with(mContext).load(path).placeholder(R.mipmap.user_empty).dontAnimate().error(R.mipmap.user_empty).into(mImageView);
    }
    //设置加载中以及加载失败图片
    public static void loadImageView(Context mContext, String path, ImageView mImageView) {
        Glide.with(mContext).load(path).placeholder(R.color.lightgray).dontAnimate().error(R.color.lightgray).into(mImageView);
    }
